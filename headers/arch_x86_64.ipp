...
inline std::vector<uint8_t> generate_dlclose_shellcode(uintptr_t handle, uintptr_t dlclose_addr) {
    std::vector<uint8_t> shellcode = {
        0x55, 0x48, 0x89, 0xe5, 0x57, 0x50, 0x48, 0x83, 0xec, 0x08,
        0x48, 0xbf, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x48, 0xb8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0xff, 0xd0,
        0x48, 0x83, 0xc4, 0x08, 0x58, 0x5f, 0x5d, 0xcc, 0xc3
    };
    const size_t HANDLE_OFFSET = 19, DLCLOSE_OFFSET = 29;
    *reinterpret_cast<uintptr_t*>(&shellcode[HANDLE_OFFSET]) = handle;
    *reinterpret_cast<uintptr_t*>(&shellcode[DLCLOSE_OFFSET]) = dlclose_addr;
    return shellcode;
}
