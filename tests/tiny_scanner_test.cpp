...
int main(int argc, char *argv[]) {
    ...
    std::cout << "Replace result: " << (replace_result ? "SUCCESS" : "FAILURE")
              << std::endl;
    ...
    std::cout << "Rollback zero result: "
              << (rollback_func_result ? "SUCCESS" : "FAILURE") << std::endl;
    manager.print_library_tracker();
    ...
    std::cout << "Rollback all result: " << (rollback_all_result ? "SUCCESS" : "FAILURE")
              << std::endl;
    manager.print_library_tracker();
