...
void test_single_function_replace(DL_Manager &manager,
                                  const std::string &target,
                                  const std::string &new_lib,
                                  const std::string &func) {
    print_separator("Testing single function replace: " + func);
    std::cout << "Replacing " << target << " with " << new_lib << " for function "
              << func << std::endl;
...
void test_all_functions_replace(DL_Manager &manager,
                                const std::string &target,
                                const std::string &new_lib) {
    print_separator("Testing replace all functions");
    std::cout << "Replacing " << target << " with " << new_lib << " for ALL functions"
              << std::endl;
...
void test_sequence(DL_Manager &manager) {
    ...
    std::string base_path =
        "/home/kotlyarovm/Documents/VSCode/4sem_26/Final_project/Live_patching/build/";
...
int main(int argc, char *argv[]) {
    ...
    std::cout << "Make sure target program is running with multiple math functions"
              << std::endl;
